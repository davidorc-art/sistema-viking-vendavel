  ...
  if (error) {
    ...
    data.forEach(a => {
      ...
      if (a.consent_data) {
        ...
        console.log(`  professionalSignature length=${cd.professionalSignature ? cd.professionalSignature.length : 0}`);
        console.log(`  professional_signature length=${cd.professional_signature ? cd.professional_signature.length : 0}`);
      }
    });
  }
}
