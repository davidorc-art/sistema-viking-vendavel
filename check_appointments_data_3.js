  ...
  if (error) {
    ...
    data.forEach(a => {
      ...
      if (a.consent_data) {
        ...
        console.log(`  professionalSignature value: ${JSON.stringify(cd.professionalSignature)}`);
        console.log(`  professional_signature value: ${JSON.stringify(cd.professional_signature)}`);
      }
    });
  }
}
